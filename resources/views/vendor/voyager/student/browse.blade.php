...
<!-- resources/views/vendor/voyager/students/browse.blade.php -->
@extends('voyager::master')
...
@section('page_header')
    <div class="container-fluid">
        ...
        <!-- Import Form -->
        <form action="{{ route('import.students') }}" method="POST" enctype="multipart/form-data" style="display: inline-block;">
            @csrf
            <div class="form-group" style="display: inline-block; margin-bottom: 0;">
                <input type="file" name="file" class="form-control" style="display: inline-block; width: auto;" required>
            </div>
            <button type="submit" class="btn btn-primary">
                <i class="voyager-upload"></i> Import Students
            </button>
        </form>
    </div>
@stop
